...
import com.jcaa.usersmanagement.infrastructure.adapter.persistence.repository.RoomRepositoryMySQL;
...
public final class DependencyContainer {
  ...
  public DependencyContainer() {
    ...
    final CreateRoomUseCase createRoomUseCase = new CreateRoomService(roomRepository, roomRepository, validator);
    final UpdateRoomUseCase updateRoomUseCase = new UpdateRoomService(roomRepository, roomRepository, validator);
